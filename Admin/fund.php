          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Pay Money</h3>
              </div>
           <!--  -->
              <!-- /.card-header -->
              <!-- form start -->
               <form action="<?php echo api_url('Add_fund')?>" method="POST" id="formLogin" enctype='multipart/form-data'>
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <input type="number"  class="form-control" id="exampleInputEmail1"name="amount" value="" placeholder="AMOUNT" required="">
                  </div>
                   <!-- <div class="form-group">
