...
$t_record=$classAdmin->totalRecord('count(id) as ids','e_pin',' where status="1"');
?>
<style>
 .btn{
  margin:2px;
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Total  Approved  (<?php echo $t_record?>)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover" >
                  ...
                  <tbody>
                    ...
                    $i=$offset+1;
                    $data=$classAdmin->page_Record('* ',' e_pin ', $offset, $limit,' where status="1"');
                 ...
                 <?php  
                  ...
                  $b=$a-1;
                  for($i=0;$i<=$b;$i++){
                    echo '<a href="approvedE-pin.php?page='.($i*10).'">'.$i.'</a>';
                  }
