...
$t_record=$classAdmin->totalRecord('count(id) as ids','fund_request',' where status="1"');
?>
<style>
 .btn{
  margin:2px;
              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover" >
                  ...
                  <tbody>
                    ...
                    $i=$offset+1;
                    $data=$classAdmin->page_Record('* ',' fund_request ', $offset, $limit,' where status="1"');
                 ...
                 <?php  
                  ...
                  $b=$a-1;
                  for($i=0;$i<=$b;$i++){
                    echo '<a href="approved.php?page='.($i*10).'">'.$i.'</a>';
                  }
