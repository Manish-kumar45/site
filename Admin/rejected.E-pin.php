...
$t_record=$classAdmin->totalRecord('count(id) as ids','e_pin',' where status="2"');
?>
<style>
 .btn{
  margin:2px;
              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover" >
                  ...
                  <tbody>
                    ...
                    $i=$offset+1;
                    $data=$classAdmin->page_Record('* ',' e_pin ', $offset, $limit,' where status="2"');
                 ...
                 <?php  
                  ...
                  $b=$a-1;
                  for($i=0;$i<=$b;$i++){
                    echo '<a href="rejectedE-pin.php?page='.($i*10).'">'.$i.'</a>';
                  }
