...
$A_info=$classAdmin->singleRecord('*','users','where user_id="'.$_SESSION['admin_id'].'"');
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $A_info['name']?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview m">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="uploadcategory.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Upload Category</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview m">
           ...
           <li class="nav-item has-treeview m">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="RequestE-pin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>E-Pin Request</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="approvedE-pin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Approved E-pin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="rejectedE-pin.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Rejected E-Pin</p>
                </a>
              </li>
