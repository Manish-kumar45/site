          ...
          <div class="col-md-7">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"> E-Pin Request</h3>
              </div>
           <!--  -->
              <!-- /.card-header -->
              <!-- form start -->
               <form action="<?php echo api_url('E_pin')?>" method="POST" id="formLogin" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <!-- <div class="form-group">
                    <input type="number"  class="form-control" name="epin" value="" placeholder="No. Of E-Pin" required="">
                  </div> -->
                   <div class="form-group">
                    <input type="number"  class="form-control"  value=""  name="amount" required="" placeholder="Amount">
                  </div>
                   <div class="form-group">
                  <div class="form-group">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered  table-responsiv">
                  ...
                  <tbody><h3> E-Pin Request  </h3>
                    ...
                    // }
                    // $j=$offset+1;
                    $data = $classAdmin->LoopRecord('*',' e_pin ',' where user_id="'.$_SESSION['user_id'].'"');
