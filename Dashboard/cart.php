          ...
          <div class="col-md-5">
            ...
            total=<?php echo $value['total_price'];?>
              <div class="number-spinner d-flex">
                  <span class="ns-btn d-inline" >
                  <a data-dir="dwn" class="a-" onclick="add_quantity(<?php echo $key;?>)" href="<?php echo api_url('minus_product_quantity&id='.$value['id'].'&price='.$data1['price'].'&quantity='.$value['quantity']) ?>"> <i class="fa fa-minus" aria-hidden="true"></i></a>
                  </span>
                  <input type="number" class="pl-ns-value" name="quantity" id="quantity<?php echo $key;?>" onchange ="add_quantity(<?php echo $key;?>)" value="<?php echo $value['quantity']?>">
                  <span class="ns-btn">
                  <a data-dir="up" class="a-" value="" onclick="add_quantity(<?php echo $key;?>)" href="<?php echo api_url('add_product_quantity&id='.$value['id'].'&price='.$data1['price'].'&quantity='.$value['quantity']) ?>"><i class="fa fa-plus" aria-hidden="true"></i></a>
                  </span>
</div>
